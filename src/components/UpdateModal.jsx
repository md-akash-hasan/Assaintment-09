...
export function UpdateModal({ car }) {
  ...
  let hendelupdate = async (e) => {
    e.preventDefault();
    let formDatas = new FormData(e.currentTarget);
    let formData = Object.fromEntries(formDatas.entries());
            ...
            <Modal.Dialog className="sm:max-w-2xl flex flex-col max-h-[90vh]">
              ...
              <Modal.Body className="px-6 py-4 overflow-y-auto max-h-[70vh] flex-1 ">
                <Surface variant="default">
                  <form className="space-y-4" onSubmit={hendelupdate}>
